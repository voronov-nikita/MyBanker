//
// Кнопка "Создать". Данная кнопка присутствует в страницах, где пользователь создает новую информацию.
// В файле предствлены две кнопки: основная-рабочая, ложная-не рабочая.
//
