//
// Страница по созданию новой цели по накоплению и распределению.
// Для создания "цели" необходимо придумать название или сразу на что копить,
// далее нужно добавить желаемую сумму накопления, 
...
export const AddNewTargetScreen = ({ navigation }) => {
	...
	// функция отрисовки кнопки реализации по условию заполнения необходимых ячеек
	renderButton = () => {
